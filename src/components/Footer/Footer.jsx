            ...
            <div className="sm:flex items-center justify-between md:gap-8">
                ...
                <div className="w-full sm:w-1/2">
                    <p className="text-gray-300 leading-7 mt-4 sm:mt-0">
                        Crafting stunning websites and intuitive applications is my passion. Let's turn your ideas into reality with clean, efficient code and responsive design. Elevate your digital presence with cutting-edge web development and seamless user experiences.
                    </p>
                    ...
                    <div className="flex items-center gap-4 flex-wrap md:gap-8 mt-10">
                        ...
                        <span className="w-[35px] h-[35px] bg-[#2b2d33] p-1 rounded-[50px] cursor-pointer text-center">
                            <a href="#github" className="text-gray-300 font-[500] text-[18px]"><i class="ri-instagram-line"></i></a>
                        </span>
                        <span className="w-[35px] h-[35px] bg-[#2b2d33] p-1 rounded-[50px] cursor-pointer text-center">
                            <a href="#facebook" className="text-gray-300 font-[500] text-[18px]"><i class="ri-facebook-line"></i></a>
                        </span>
                        <span className="w-[35px] h-[35px] bg-[#2b2d33] p-1 rounded-[50px] cursor-pointer text-center">
                            <a href="#github" className="text-gray-300 font-[500] text-[18px]"><i class="ri-mail-line"></i></a>
                        </span>
                    </div>
                </div>
            </div>
                ...
                <div className="flex items-center justify-center sm:justify-between">
                    ...
                    <div className="hidden sm:block">
                        ...
                        <div className="leading-[20px]">
                            <h2 className="text-gray-200 font-[500] text-[18px]">RhonDev's</h2>
