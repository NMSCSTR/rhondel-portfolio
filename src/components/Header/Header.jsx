            ...
            <div className="flex items-center justify-between">
                ...
                <div className="menu" ref={menuRef} onClick={toggleMenu}>
                    <ul className="flex items-center gap-10">
                        <li><a onClick={handeClick} className="text-smallTextColor font-[600]" href="#about">About</a></li>
                        <li><a onClick={handeClick} className="text-smallTextColor font-[600]" href="#services">Services</a></li>
                        <li><a onClick={handeClick} className="text-smallTextColor font-[600]" href="#portfolio">Portfolio</a></li>
                        <li><a onClick={handeClick} className="text-smallTextColor font-[600]" href="#contact">Contact</a></li>
                    </ul>
                </div>
                {/* ========== Menu end  ========== */}
